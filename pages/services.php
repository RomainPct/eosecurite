<?php 
$c = new CandidePage('services');
$c1 = new CandideCollection('services');
?>
...
<main class="servicesContainer comingFade">
    <section class="servicesContainer__servicesSection">
        <div class="servicesContainer__servicesSection__cattop">
            <h2><?php $c->text('titre_pour_les_services'); ?></h2>
            <p><?php $c->text('description_des_services'); ?></p>
        </div>
        ...
        foreach(array_reverse($c1->avalaibleItemIds()) as $id){
            ...
            <div class="servicesContainer__servicesSection__cat">
                <h2 class="white"><?php $c1->text('titre_du_service', $id); ?></h2>
                <p class="white"><?php $c1->text('description_du_service', $id); ?></p>
            </div>
            <?php
        }
        ?> 
